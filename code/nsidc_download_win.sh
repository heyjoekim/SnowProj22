...
# get WY 2019
wget --http-user=$1 --http-password=$2 --load-cookies mycookies.txt --save-cookies mycookies.txt --keep-session-cookies --no-check-certificate --auth-no-challenge=on -r --reject "index.html*" -np -e robots=off -nd https://n5eil01u.ecs.nsidc.org/SNOWEX/WUS_UCLA_SR.001/2018.10.01/WUS_UCLA_SR_v01_N47_0W110_0_agg_16_WY2018_19_SWE_SCA_POST.nc
